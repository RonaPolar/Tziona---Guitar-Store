    ...
    <div class="pay-modal-content">
      ...
      <div class="pay-form">
        ...
        <form action="#">
          ...
          <span class="currency"> Current bid: &#8369; 8,000</span>
          <input type="number" class="bet-field" placeholder="Enter your bet" autocomplete="off" required>
              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-content">
                    ...
                    <button class="add-cart-btn"id="button1">Participate</button>
